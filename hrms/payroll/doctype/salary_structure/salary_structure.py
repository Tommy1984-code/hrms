...
def assign_salary_structure_for_employees(
	...
	variable=None,
	income_tax_slab=None,
	payment_type = None #my code adding payment_type
):
	assignments = []
	...
	for employee in employees:
		try:
			...
			assignment = create_salary_structure_assignment(
				...
				variable,
				income_tax_slab,
				payment_type #mycode adding payment_type
			)
...
def create_salary_structure_assignment(
	...
	variable=None,
	income_tax_slab=None,
	payment_type = None #mycode adding payment type
):
	...
	assignment.payment_type = payment_type #my code adding payment type
