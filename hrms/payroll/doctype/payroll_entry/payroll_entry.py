...
class PayrollEntry(Document):
	...
	def validate_existing_salary_slips(self):
		...
		existing_salary_slips = (
			...
			.where(
				...
				& (SalarySlip.payment_type == self.payment_type)
	...
	def make_filters(self):
		filters = frappe._dict(
			...
			payment_type = self.payment_type,#my code adding payment_type
	...
	def fill_employee_details(self):
		...
		if not employees:
			...
			if self.payment_type:
				error_msg += "<br>" + _("Payment Type: {0}").format(frappe.bold(self.payment_type))#my code adding payment type
	...
	def get_sal_slip_list(self, ss_status, as_dict=False):
		...
		ss_list = (
			...
			.where(
				...
				& (ss.payment_type == self.payment_type)#my code addig payment type
	...
	def get_salary_slip_details(self, for_withheld_salaries=False):
		...
		query = (
			...
			.where(
				...
				& (SalarySlip.payment_type == self.payment_type)#my code adding payment type
			)
		)
...
def get_filtered_employees(
	...
	query = (
		...
		.where(
			...
			& (SalaryStructureAssignment.payment_type == filters.payment_type)# my code adding payment type
...
#this is the code that is important to bring the employee based on the salary slip
def remove_payrolled_employees(emp_list, start_date, end_date,payment_type): # my code i added payment_type as argument and filter
	SalarySlip = frappe.qb.DocType("Salary Slip")
	...
	employees_with_payroll = (
		...
		.where(
			...
			& (SalarySlip.payment_type == payment_type)#my code added payment type
		)
	).run(pluck=True)
...
def get_existing_salary_slips(employees, args):
	...
	return (
		...
		.where(
			...
			& (SalarySlip.payment_type == args.payment_type)
		)
	).run(pluck=True)
...
def get_employee_list(
	...
	return remove_payrolled_employees(employees_to_check, filters.start_date, filters.end_date, filters.payment_type)
